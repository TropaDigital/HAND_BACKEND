...
describe('DELETE /associateds/{id} - Delete associated by id', () => {
  ...
  it('Should return 204 when the associated is deleted', async () => {
    const id = 1;
  ...
  it('Should return 500 when the service throws an exception error', async () => {
    const id = 1;
    jest
      .spyOn(AssociatedService.prototype, 'deleteById')
