...
class Api_IndexController extends My_Controller 
{
	...
	public function newContatoAction()
	{
		...
		$this->contatos->_required(array('id_contato', 'id_lista', 'nome', 'sobrenome', 'data_nascimento', 'email', 'celular', 'campo1', 'campo2', 'campo3', 'campo4', 'campo5', 'campo6', 'campo7', 'campo8', 'campo9', 'campo10', 'campo11', 'editavel_1', 'editavel_2', 'editavel_3', 'editavel_4', 'editavel_5', 'editavel_6', 'editavel_7', 'editavel_8', 'editavel_9', 'modificado', 'criado'));
	...
	public function updateContatoAction()
	{
		...
		$this->edit->_required(array('id_contato', 'id_lista', 'nome', 'sobrenome', 'data_nascimento', 'email', 'celular', 'campo1', 'campo2', 'campo3', 'campo4', 'campo5', 'campo6', 'campo7', 'campo8', 'campo9', 'campo10', 'campo11', 'editavel_1', 'editavel_2', 'editavel_3', 'editavel_4', 'editavel_5', 'editavel_6', 'editavel_7', 'editavel_8', 'editavel_9', 'modificado', 'criado'));
	...
	public function selectListaAction()
	{
		...
		$this->view->lista_contatos = $lista_contatos->fetchAll('id_usuario = '.$post['id_usuario'].' AND oculto = \'0\' ');
